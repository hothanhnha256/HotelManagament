...
export default function RoomDetail(props: RoomInterface) {
    ...
    const handleUpdate = async (e: React.FormEvent) => {
        ...
        if (newRoom.housekeeperId) formData.append("housekeeperId", newRoom.housekeeperId);
        if (newRoom.discountId) formData.append("discountId", newRoom.discountId);
        if (newRoom.roomInChargePersonID) formData.append("roomInChargePersonID", newRoom.roomInChargePersonID);
        if (newRoom.capacity !== undefined) formData.append("capacity", newRoom.capacity.toString());
        if (newRoom.linkedRoomId) formData.append("linkedRoomId", newRoom.linkedRoomId);
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-md max-h-[90vh] overflow-y-auto">
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-xl font-bold text-black dark:text-white">Chi tiết phòng</h2>
                    <button
                ...
                <div className="text-black dark:text-white">
                    ...
                    <p>
                        <strong>Loại phòng:</strong> {roomTypeMapping(props.entry?.LoaiPhong)}
                    </p>
                    <p>
                ...
                <form onSubmit={handleUpdate}>
                    <div className="mb-4">
                        <label className="block text-gray-700 dark:text-gray-300">Trạng thái</label>
                        <select
                            name="status"
                    ...
                    <div className="mb-4">
                        <label className="block text-gray-700 dark:text-gray-300">Mô tả</label>
                        <input
                            type="text"
                            name="description"
                    ...
                    <div className="mb-4">
                        <label className="block text-gray-700 dark:text-gray-300">ID nhân viên dọn phòng</label>
                        <input
                            type="text"
                            name="housekeeperId"
                    ...
                    <div className="mb-4">
                        <label className="block text-gray-700 dark:text-gray-300">ID giảm giá</label>
                        <input
                            type="text"
                            name="discountId"
                    ...
                    <div className="mb-4">
                        <label className="block text-gray-700 dark:text-gray-300">ID nhân viên phòng</label>
                        <input
                            type="text"
                    ...
                    <div className="mb-4">
                        <label className="block text-gray-700 dark:text-gray-300">Sức chứa</label>
                        <input
                            type="number"
                            name="capacity"
                    ...
                    <div className="mb-4">
                        <label className="block text-gray-700 dark:text-gray-300">Mã phòng liên kết</label>
                        <input
                            type="text"
                            name="linkedRoomId"
