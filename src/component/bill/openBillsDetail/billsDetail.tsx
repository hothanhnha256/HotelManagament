...
const fakeDataOrders: BillsProps = {
  id: "1",
  date: "2021-09-01",
...
export default function BillsDetail(props: BillsInterface) {
  const [order, setOrder] = useState<BillsProps | null>(null);
